...
nn.predict(nn, input)   #   hidden layer 1개 노드 2개

nn <- nn.train(input, output, hidden=c(2,2), learningrate=10, numepochs=10000)
nn.predict(nn, input)   #   hidden layer 2개 노드 2개
